...
void main() => runApp(Estacion7());

class Estacion7 extends StatelessWidget {
  @override
        ...
        body: Container(
          decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('assets/images/estacion7.png'),
              fit: BoxFit.cover,
                      ...
                      children: [
                        Container(
                          ...
                          child: ElevatedButton(
                            ...
                            child: Text("Estación 7",style: TextStyle(fontSize: 25),
                            key: key ,
                          ),
                        ),
                        ),
              ...
              child: ListView(
                children: [
                  Container(
                    ...
                    child: Center(
                      child: Text(
                          "BABILLAS", style: TextStyle(fontSize: 25)),
                    ),
                  ),
                  Container(
                    ...
                    child: Center(
                        child: Text(
                          "Humedal de interés ecológico por presencia de fauna silvestre como reptiles (babilas, totugas) y aves. Punto de estudio de la bilogía de la conservación.",
              ...
              children: [
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: (){},
                    child: Text("Tortuga sabanera",style: TextStyle(fontSize: 25)),
                  ),
                ),
                Container(
                  height: 50,
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: (){},
                    child: Text("Pava hedionda",style: TextStyle(fontSize: 25)),
                  ),
                ),
                Container(
                  height: 50,
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: (){},
                    child: Text("Babillas, cachirre",style: TextStyle(fontSize: 25),),
                  ),
                ),
                Container(
                  height: 50,
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: (){},
                    child: Text("Morrocoy",style: TextStyle(fontSize: 25)),
                  ),
                ),
                Container(
                  height: 50,
              ...
              children: [
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: (){},
                    child: Text("Siparunaceae",style: TextStyle(fontSize: 25)),
                  ),
                ),
                Container(
                  height: 50,
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: (){},
                    child: Text("Musacea",style: TextStyle(fontSize: 25)),
                  ),
                ),
                Container(
                  height: 50,
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: (){},
                    child: Text("Gramineas",style: TextStyle(fontSize: 25)),
                  ),
                )
