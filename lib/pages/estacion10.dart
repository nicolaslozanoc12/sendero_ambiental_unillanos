...
void main() => runApp(Estacion10());

class Estacion10 extends StatelessWidget {
  @override
        ...
        body: Container(
          decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('assets/images/estacion10.png'),
              fit: BoxFit.cover,
                      ...
                      children: [
                        Container(
                          ...
                          child: ElevatedButton(
                            ...
                            child: Text("Estación 10",style: TextStyle(fontSize: 25),
                            key: key ,
                          ),
                        ),
                        ),
              ...
              child: ListView(
                children: [
                  Container(
                    ...
                    child: Center(
                      child: Text(
                          "PTAR", style: TextStyle(fontSize: 25)),
                    ),
                  ),
                  Container(
                    ...
                    child: Center(
                        child: Text(
                          "La planta de tratamiento de aguas residuales (PTAR) además de cumplimiento normativo, permite estudiar el recurso de agua y su interacción con los ecosistemas presentes. Tema fundamental en la concientización de la gestión integral de recursos hídricos en la institución.",
              ...
              children: [
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: (){},
                    child: Text("Oso hormiguero",style: TextStyle(fontSize: 25)),
                  ),
                ),
                Container(
                  height: 50,
              ...
              children: [
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: (){},
                    child: Text("Primulaceae",style: TextStyle(fontSize: 25)),
                  ),
                ),
                Container(
                  height: 50,
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: (){},
                    child: Text("Rutaceae",style: TextStyle(fontSize: 25)),
                  ),
                ),
                Container(
                  height: 50,
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: (){},
                    child: Text("Boraginaceae",style: TextStyle(fontSize: 25)),
                  ),
                ),
                Container(
                  height: 50,
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: (){},
                    child: Text("Solanaceae",style: TextStyle(fontSize: 25)),
                  ),
                ),
                Container(
                  height: 50,
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: (){},
                    child: Text("Asysasia",style: TextStyle(fontSize: 25)),
                  ),
                ),
                Container(
                  height: 50,
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: (){},
                    child: Text("Senna",style: TextStyle(fontSize: 25)),
                  ),
                ),
                Container(
                  height: 50,
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: (){},
                    child: Text("Pteridofitos",style: TextStyle(fontSize: 25)),
                  ),
                )
