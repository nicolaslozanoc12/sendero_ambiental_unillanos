...
void main() => runApp(Estacion15());

class Estacion15 extends StatelessWidget {
  @override
                      ...
                      children: [
                        Container(
                          ...
                          child: ElevatedButton(
                            ...
                            child: Text("Estación 15",style: TextStyle(fontSize: 25),
                            key: key ,
                          ),
                        ),
                        ),
              ...
              child: ListView(
                children: [
                  Container(
                    ...
                    child: Center(
                      child: Text(
                          "MUSEO DE HISTORIA NATURAL", style: TextStyle(fontSize: 25)),
                    ),
                  ),
                  Container(
                    ...
                    child: Center(
                        child: Text(
                          "Lugar que guarda especiaes biológica de la región, fundamental en la concientización y apropiación de conocimiento de las diferentes prácticas e investigaciones que adelanta la universidad en pro de la biología de las especies y la consevación",
            ...
            child: ListView(
              children: [
                ...
                Container(
                  ...
                  height: 50,
                    child: Center(
                        child: Text("No se registra info",style: TextStyle(fontSize: 25)),
                  ),
                ),
              ],
            ),
              ...
              children: [
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: (){},
                    child: Text("Bauhinia",style: TextStyle(fontSize: 25)),
                  ),
                ),
                Container(
                  height: 50,
